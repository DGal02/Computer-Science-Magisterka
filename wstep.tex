...
\begin{itemize}
    ...
    \item Porównanie narzutu wirtualizacji (WSL 2 vs natywny Linux) oraz kosztów włączenia gwarancji trwałości danych (fsync/WAL).
\end{itemize}
...
\begin{enumerate}
    ...
    \item Jaki koszt w postaci spadku przepustowości niesie ze sobą wymuszenie pełnej trwałości transakcji (operacje fsync/WAL)?
\end{enumerate}
