...
\begin{itemize}
    ...
    \item \textbf{Dysk twardy:} nośnik SSD M.2 PCIe NVMe o pojemności 1 TB. Przepustowość nośnika zmierzona za pomocą pakietu \texttt{fio} wyniosła 1,8~GB/s dla operacji odczytu sekwencyjnego oraz 1,1~GB/s dla operacji zapisu sekwencyjnego.
\end{itemize}
